...
// const age = 34;
// const myAge = prompt('Ok. Ready, ' + username + '? How old am I? You have 4 tries' ).toLowerCase;
// let i = 0;

// while (i < 3) {
//     if ( myAge <= 33 ) {
//         prompt('Nope! Too low. Try again. You have ' + (3 - i) + 'remaining');
//         console.log(myAge);
//     }
...
//     else if (myAge >= 35) {
//         prompt('Nope! Too high. Try again. You have ' + (3 - i) + 'remaining');
//         console.log(myAge);
//         i++;
//     }
